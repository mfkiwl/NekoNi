...
initial begin
	...
	/*registers[16] <= 32'h00000000; // Conform to RV32E, half register count
...
assign rval1 = registers[rs1[3:0]];
assign rval2 = registers[rs2[3:0]];
